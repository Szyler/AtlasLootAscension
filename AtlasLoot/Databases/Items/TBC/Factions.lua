...
AtlasLoot:AddItemData("dontSort", {
    ...
    ["VioletEye"] = {
		{
			{ icon = "INV_Jewelry_Ring_62", name = "Path of the Violet Assassin" },
			...
			{ icon = "INV_Jewelry_Ring_62", name = "Path of the Violet Mage" },
			{ itemID = 29284 }, --Violet Signet
			{ itemID = 29285 }, --Violet Signet
			{ itemID = 29286 }, --Violet Signet
			{ itemID = 29287 }, --Violet Signet of the Archmage
			{ icon = "INV_Jewelry_Ring_62", name = "Path of the Violet Restorer", pageBreak = true },
			...
			{ icon = "INV_Jewelry_Ring_62", name = "Path of the Violet Protector" },
