...
function AtlasLoot:CreateAdvancedSearchFrame()
    ...
    searchPanel.clearbtn = CreateFrame("Button", "AtlasLoot_Search_ClearButton", searchPanel, "UIPanelButtonTemplate2")
    searchPanel.clearbtn:SetSize(110,20)
    searchPanel.clearbtn:SetPoint("BOTTOMRIGHT", searchPanel, "BOTTOMRIGHT", -15, 15)
    searchPanel.clearbtn:SetScript("OnShow", function(button)
        button:SetText(AL["Clear"])
        button:SetFrameLevel( (button:GetParent()):GetFrameLevel() + 1 )
    end)
    searchPanel.clearbtn:SetScript("OnClick", function()
