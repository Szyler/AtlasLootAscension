...
function AtlasLoot:CreateAdvancedSearchFrame()
    ...
    self.searchPanel = CreateFrame("FRAME", "AtlasLoot_AdvancedSearchPanel", self.ui.tabs.Loot, nil)
    self.searchPanel:SetPoint("TOPLEFT", self.ui.tabs.Loot, "TOPLEFT", 2, -2)
    self.searchPanel:SetSize(510, 510)
    self.searchPanel.closebtn = CreateFrame("Button", "AtlasLoot_AdvancedSearchPanel_CloseButton", self.searchPanel, "UIPanelCloseButton")
    ...
    self.searchPanel.searchCategory = CreateFrame("Button", "AtlasLoot_AdvancedSearchPanel_CategoryButton", self.searchPanel, "OptionsButtonTemplate")
    ...
    self.searchPanel.equipbtn = CreateFrame("Button", "AtlasLoot_AdvancedSearchPanel_EquipButton", self.searchPanel, "OptionsButtonTemplate")
    ...
    self.searchPanel.equipbtn.subbtn = CreateFrame("Button", "AtlasLoot_AdvancedSearchPanel_EquipSubButton", self.searchPanel.equipbtn, "OptionsButtonTemplate")
    ...
    self.searchPanel.levelmin = CreateFrame("EditBox", "AtlasLoot_AdvancedSearchPanel_LevelMin", self.searchPanel, "InputBoxTemplate")
    ...
    self.searchPanel.levelmax = CreateFrame("EditBox", "AtlasLoot_AdvancedSearchPanel_LevelMax", self.searchPanel, "InputBoxTemplate")
    ...
    self.searchPanel.ilevelmin = CreateFrame("EditBox", "AtlasLoot_AdvancedSearchPanel_iLevelMin", self.searchPanel, "InputBoxTemplate")
    ...
    self.searchPanel.ilevelmax = CreateFrame("EditBox", "AtlasLoot_AdvancedSearchPanel_iLevelMax", self.searchPanel, "InputBoxTemplate")
    ...
    self.searchPanel.useleveltick = CreateFrame("CheckButton", "AtlasLoot_AdvancedSearchPanel_LevelToggle", self.searchPanel, "ChatConfigCheckButtonTemplate")
    ...
    self.searchPanel.argpanel = CreateFrame("Frame", "AtlasLoot_AdvancedSearchPanel_ArgumentContainer", self.searchPanel)
    ...
    self.searchPanel.addArg = CreateFrame("Button", "AtlasLoot_AdvancedSearchPanel_ArgumentContainerAddArgBtn", self.searchPanel.argpanel, "OptionsButtonTemplate")
    ...
    self.searchPanel.remArg = CreateFrame("Button", "AtlasLoot_AdvancedSearchPanel_ArgumentContainerRemArgBtn", self.searchPanel.argpanel, "OptionsButtonTemplate")
    ...
    for i = 1, MAX_ARGUMENTS do
        self.searchPanel.main[i] = CreateFrame("Button", "AtlasLoot_AdvancedSearchPanel_ArgumentContainer" .. i, self.searchPanel.argpanel, "OptionsButtonTemplate")
        ...
        self.searchPanel.sub[i] = CreateFrame("Button", "AtlasLoot_AdvancedSearchPanel_ArgumentContainer" .. i .. "Sub", self.searchPanel.argpanel, "OptionsButtonTemplate")
        ...
        self.searchPanel.value[i] = CreateFrame("EditBox", "AtlasLoot_AdvancedSearchPanel_ArgumentContainer" .. i .. "Value", self.searchPanel.argpanel, "InputBoxTemplate")
    ...
    --Search Button
    self.searchPanel.searchbtn = CreateFrame("Button", "AtlasLoot_AdvancedSearchPanel_SearchButton", self.searchPanel, "UIPanelButtonTemplate2")
    ...
    self.searchPanel.clearbtn = CreateFrame("Button", "AtlasLoot_AdvancedSearchPanel_ClearButton", self.searchPanel, "UIPanelButtonTemplate2")
